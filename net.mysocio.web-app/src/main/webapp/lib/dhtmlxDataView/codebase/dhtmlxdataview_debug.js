...
dhtmlx.assert_enabled=function(){ return true; };
...
dhtmlx.ui={};
if (dhtmlx.assert_enabled()){
	dhtmlx.EventSystem._assert = function(){
		dhtmlx.assert_method(this,{
			block:{
				descr:"stop event calls until unblocking",
				args:[]
			},
			unblock:{
				descr:"restore normal event processing",
				args:[]
			},
			mapEvent:{
				descr:"route events from one object to another",
				args:[
					["map", "hash of event-object relations", dhtmlx.assert_rule_object]
				]
			},
			callEvent:{
				descr:"trigger inner event",
				skip:!dhtmlx.assert_all,
				args:[
					["name", "name of event", dhtmlx.assert_rule_string],
					["data", "set of event related data", dhtmlx.assert_rule_object]
				]
			},
			attachEvent:{
				descr:"attach custom handler to inner event, returns event id",
				args:[
					["name", "name of event", dhtmlx.assert_rule_string],
					["handler", "custom handler", dhtmlx.assert_rule_function]
				]
			},
			detachEvent:{
				desrc:"detach custom code from handler",
				args:[
					["id", "event's ID", dhtmlx.assert_rule_number]
				]
			}
		});
...
dhtmlx.Type.assert_event = function(data){
	dhtmlx.assert_check(data,{
		name:	["Name of type", dhtmlx.assert_rule_string],
		template:	["Main template", dhtmlx.assert_rule_template],
		template_edit:	["Edit template", dhtmlx.assert_rule_template],
		template_loading:	["Loading template", dhtmlx.assert_rule_template],
		
		css:	["Css class of single item", dhtmlx.assert_rule_string],
		width:	["Css class of single item", dhtmlx.assert_rule_dimension],
		height:	["Css class of single item", dhtmlx.assert_rule_dimension],
		margin:	["Css class of single item", dhtmlx.assert_rule_dimension],
		padding:["Css class of single item", dhtmlx.assert_rule_dimension]
		//drag_marker:["Css class of single item", dhtmlx.assert_rule_string]
	});
};
...
if (dhtmlx.assert_enabled()){
	dhtmlx.Settings._assert = function(){
		dhtmlx.assert_property(this,{
			type: [
				[ "Name of object's type", dhtmlx.assert_rule_string ],
				[ "Configuration of object type", dhtmlx.assert_rule_object ]
			],	
			template:	["Default template", dhtmlx.assert_rule_template ],
			css:		["Css-class for top level container", dhtmlx.assert_rule_string ],
			container:	["Container for the component", dhtmlx.assert_rule_htmlpt ]
		});
		
		dhtmlx.assert_method(this, {
			customize:{
				descr:	"change some property of current data type",
				min:"0",
				args:	[
					["obj", 	"hash of properties", 		dhtmlx.assert_rule_object, true]
				]
			},
			define:{
				descr:	"sets value for configuration property",
				args: 	[
					["property", 	"name of property", 		dhtmlx.assert_rule_string],
					["value", 		"new value of property", 	dhtmlx.assert_rule_any]
				]				
			}
		});	
	};
...
if (dhtmlx.assert_enabled()){
	dhtmlx.Destruction._assert=function(){
		dhtmlx.assert_method(this,{
			destructor:{
				descr:"remove component and all realted data",
				args:[]
			}
		});
	};
...
if (dhtmlx.assert_enabled()){
	dhtmlx.ui.pager.prototype._assert=function(){
		
	dhtmlx.assert_property(this,{
		size: 	["expected count of items per page", dhtmlx.assert_rule_dimension ],
		count:	["expected count of items", dhtmlx.assert_rule_dimension ],
		page:	["current page", dhtmlx.assert_rule_number ],
		group: 	["count of pages in group", dhtmlx.assert_rule_dimension ]
	});
	dhtmlx.assert_event(this,{
		//before page changed, will not be triggered for direct config.page updates
		onbeforepagechange:{
			descr:"page change is activated",
			old_page:"previously active page",
			new_page:"new active page"
		},
		//	after page changed, will not be triggered for direct config.page updates
		onafterpagechange:{
			descr:"active page was changed",
			active:"currectly active page"
		},
		onrefresh:{
			descr:"each time when page or limit value was changed"
		}
	});
...
if (dhtmlx.assert_enabled()){
	dhtmlx.SingleRender._assert=function(){
		dhtmlx.assert_event(this,{
			onbeforerender:{
				descr:"view rendering is initiated",
				data:"hash of data, which is used for rendering"
			},	
			onafterrender:{
				descr:"view was rendered"
			}
		});			
	};
}
...
if (dhtmlx.assert_enabled()){
	dhtmlx.ui.Tooltip.prototype._assert=function(){
		dhtmlx.assert_property(this,{
			dx: ["x correction for tooltip position", dhtmlx.assert_rule_number ],
			dy: ["y correction for tooltip position", dhtmlx.assert_rule_number ]
		});
	};
}
...
if (dhtmlx.assert_enabled()){
	dhtmlx.AutoTooltip._assert=function(){
		dhtmlx.assert_property(this,{
			tooltip: [
				[ "Template for tooltip", dhtmlx.assert_rule_template ],
				[ "Tooltip's configuration", dhtmlx.assert_rule_object ]
			]
    	});
	};
}
...
if (dhtmlx.assert_enabled()){
	dhtmlx.DataProcessor._assert=function(){
		dhtmlx.assert_method(this,{
			changeId:{
				descr:"change it of item",
				args:[
					["id",	"existing id of item",	dhtmlx.assert_rule_any],
					["new_id",	"new id of item",	dhtmlx.assert_rule_any]
				]
			}
		});
	};
...
dhtmlx.compat.dnd = function(){
	...
	if (window.dhtmlDragAndDropObject){
		...
		dhtmlDragAndDropObject.prototype.checkLanding=function(node,e,skip){
			...
			if (!skip){ 
				dhtmlx.DragControl._drag_context = dhtmlx.DragControl._drag_context||{};
...
if (dhtmlx.assert_enabled()){
	dhtmlx.DataMove._assert = function(){
		dhtmlx.assert_method(this,{
			copy:{
    			descr:"copy item in question to the target position",
    			min:2,
    			args:	[
    				["source_id",	"id of item which will be copied",		dhtmlx.assert_rule_any],
    				["index",	"position, to which item need to be copied",	dhtmlx.assert_rule_dimension],
    				["target_obj",	"target component",		dhtmlx.assert_rule_object,	true],
    				["target_id",	"id which will be assigned to the item, after moving",		dhtmlx.assert_rule_any, true]
				]
    		},
    		move:{
    			descr:"move item in question to the target position",
    			min:2,
    			args:	[
    				["source_id",	"id of item which will be copied",		dhtmlx.assert_rule_any],
    				["index",	"position, to which item need to be copied",	dhtmlx.assert_rule_dimension],
    		...
    		moveUp:{
    			descr:"move item up of one or few positions",
    			min:1,
    			args:	[
    				["source_id",	"id of item which will be moved",		dhtmlx.assert_rule_any],
    				["step",	"how far item need to be moved",	dhtmlx.assert_rule_dimension, true]
    			]
    		},
    		moveDown:{
    			descr:"move item down of one or few positions",
    			min:1,
    			args:	[
    				["source_id",	"id of item which will be moved",		dhtmlx.assert_rule_any],
    				["step",	"how far item need to be moved",	dhtmlx.assert_rule_dimension, true]
    		...
    		moveTop:{
    			descr:"move item to the top position",
    			args:	[
    				["source_id",	"id of item which will be moved",		dhtmlx.assert_rule_any]
    			]
    		},
    		moveBottom:{
    			descr:"move item to the bottom position",
    			args:	[
    				["source_id",	"id of item which will be moved",		dhtmlx.assert_rule_any]
    			]
    		}
...
if (dhtmlx.assert_enabled()){
	dhtmlx.DragItem._assert=function(){
		
		dhtmlx.assert_event(this,{
        	ondragout:{
        		descr:"drag moved outside of droppable area",
        		context:"drag and drop context",
        		native_event:"HTML event object"
    		},
			onbeforedrag:{
        		descr:"mouse button pressed and moved over draggable item",
        		context:"drag and drop context",
        		native_event:"HTML event object"
    		},
			onbeforedragin:{
        		descr:"drag moved over droppable area",
        		context:"drag and drop context",
        		native_event:"HTML event object"
    		},
			onbeforedrop:{
        		descr:"drag released over droppable area",
        		context:"drag and drop context",
        		native_event:"HTML event object"
    		},
			onafterdrop:{
        		descr:"drag-n-drop finished",
        		context:"drag and drop context",
        		native_event:"HTML event object"
    		}
        });
        dhtmlx.assert_property(this,{
        	drag: ["Enables or disables dnd", dhtmlx.assert_rule_boolean ]
    	});
...
if (dhtmlx.assert_enabled()){
	dhtmlx.EditAbility._assert=function(){
		
		dhtmlx.assert_event(this,{
			onbeforeeditstart:{
				descr:"edit operation initiated",
				id:"id of item, which will be edited"
			},
			onaftereditstart:{
				descr:"edit operation initiated, editor opened and ready for input",
				id:"id of item, which will be edited"
			},
			onbeforeeditstop:{
				descr:"stop edit command was received",
				id:"id of item, which was edited"
			},
			onaftereditstop:{
				descr:"edit operation finished",
				id:"id of item, which was edited"
			}
		});
		dhtmlx.assert_property(this,{
        	edit: [ "allow or deny edit operations", dhtmlx.assert_rule_boolean ]
    	});			
    	dhtmlx.assert_method(this,{
    		edit:{
    			descr:"switch item to the edit state",
    			args:	[
    				["id",	"id of item in question",		dhtmlx.assert_rule_any ]
    			]
    		},
    		stopEdit:{
    			descr:"swithc any item in edit state, back to normal",
    			min:"0",
    			args:	[
    				["dont_save",	"ignore value in editor and revert to old",		dhtmlx.assert_rule_boolean, true],
    				["reserved",	"reserved for inner usage",		dhtmlx.assert_rule_any, true]
    			]
    		}
		});
	};
...
if (dhtmlx.assert_enabled()){
	dhtmlx.KeyEvents._assert=function(){
		dhtmlx.assert_event(this,{
			onkeypress:{
				descr:"for each key action in default state",
				key:"key code",
				ctrl:"ctrl flag",
				shift:"shift flag",
...
if (dhtmlx.assert_enabled()){
	dhtmlx.MouseEvents._assert=function(){
		dhtmlx.assert_event(this,{
			onitemclick:{
				descr:"item was clicked",
				id:"id of clicked item",
				ev:"native event object",
				trg:"target HTML element"
			},
			onbeforecontextmenu:{
				descr:"context menu call in the item area",
				id:"id of clicked item",
				ev:"native event object"
			},
			onitemdblclick:{
				descr:"item was double-clicked",
				id:"id of clicked item",
				ev:"native event object",
				trg:"target HTML element"
			},
			onmousemove:{
				descr:"mouse was pointed over item",
				id:"id of item in question",
				ev:"native event object",
				trg:"target HTML element"
			},
			onmouseout:{
				descr:"mouse was moved out from item",
				ev:"native event object"
			},
			onmousemoving:{
				descr:"mouse was moved over component",
				ev:"native event object"
			}
		});			
	};
...
if (dhtmlx.assert_enabled()){
	dhtmlx.SelectionModel._assert=function(){
		dhtmlx.assert_event(this,{
			onbeforeselect:{
				descr:"item selection is started",
				id:"id of item",
				selection:"true if we selecting, false if unselecting"
			},
			onafterselect:{
				descr:"item was selected",
				id:"id of item"
			},
			onselectchange:{
				descr:"selection state was changed",
				ids:"aray of IDs, which selection state was changed"
			}
		});
		...
		dhtmlx.assert_property(this,{
        	select: [
				["Enable|Disable selection", dhtmlx.assert_rule_boolean ],
				["Enables multiselect mode", dhtmlx.assert_rule_key({"multiselect":true})]
			]
    	});		
    	dhtmlx.assert_method(this,{
    		unselect:{
    			...
    			min:"0",
    			args:	[
    				["id",	"id of item in question",	dhtmlx.assert_rule_any, true ]
    			]
    		},
    		unselectAll:{
    			descr:"unselect all items",
    			args:	[]
    		},
    		select:{
    			descr:"select item",
    		...
    		selectAll:{
    			descr:"select all items",
    			min: "0",
    			args:	[
    				["start_id", "id of start item", dhtmlx.assert_rule_any, true],
    				["end_id", "id of end item", dhtmlx.assert_rule_any, true]
    			]
    		},
    		isSelected:{
    			descr:"check is item selected or not",
    			args:	[
    				["id",	"id of item in question",	dhtmlx.assert_rule_any ]
    			]
    		},
    		getSelected:{
    			descr:"return ID of selected item(s)",
    			args:	[]
    		}
		});
	};
...
if (dhtmlx.assert_enabled()){
	dhtmlx.RenderStack._assert=function(){
		dhtmlx.assert_event(this,{
			onbeforerender:{
				descr:"occurs when rendering is starting",
				data:"array of data objects"
			},
			onitemrender:{
				descr:"for each item rendering, occurs only for items with custom templates",
				obj:"data hash of rendered item"
			},
			onafterrender:{
				descr:"after view rendered"				
			}
		});
		dhtmlx.assert_property(this,{
			x_count:	["Width of view in item-widths", dhtmlx.assert_rule_dimension ],
			y_count:	["Height of view in item-heights", dhtmlx.assert_rule_dimension ],
			pager:	[
				["Pager configuration", dhtmlx.assert_rule_object ],
				["Pager container", dhtmlx.assert_rule_htmlpt ]
			],
			height:	["Enables auto-height mode", dhtmlx.assert_rule_key({"auto":true}) ]
		});	
		dhtmlx.assert_method(this,{
			show:{
				descr:"adjust scroll state to show item in question",
				args:[
					["id",	"id of item in question",	dhtmlx.assert_rule_any ]
				]
			},
			locate:{
				descr:"return ID of item which is affected by HTML event",
				args:[
					["native_event",	"html event object",	dhtmlx.assert_rule_object ]
				]
			},
			render:{
				descr:"render current state of item or whole component",
				min:"0",
				args:[
					["id",	"html event object",	dhtmlx.assert_rule_any,	true],
					["data",	"hash of data for rendered item",	dhtmlx.assert_rule_object,	true],
					["type",	"type of operat",	dhtmlx.assert_rule_string,	true],
					["after",	"id of relation item",	dhtmlx.assert_rule_any,	true]
				]
			}
		});
	};
...
if (dhtmlx.assert_enabled()){
	dhtmlx.VirtualRenderStack._assert=function(){
		dhtmlx.assert_method(this,{
			render:{
				descr:"render current state of item or whole component",
				min:"0",
		...
		dhtmlx.assert_event(this,{
			onDataRequest:{
				descr:"render found not loaded data and requests loading",
				start:"position from which data is requsted",
				count:"how much records need to be loaded"
			}
		});
...
if (dhtmlx.assert_enabled()){
	dhtmlx.DataStore.prototype._assert = function(){
		dhtmlx.assert_event(this,{
			onStoreLoad:{
				descr:"after data is loaded from external resource",
				driver:"data driver",
				data:"raw external data"
			},
			onStoreUpdated:{
				descr:"after data was changed in datastore",
				id:"if of updated object",
				obj:"updated object",
				mode:"updating mode"
			},
			onClearAll:{
				descr:"after datastore was cleared"
			}
		});
		
		this.assert_event(this);
	};
	dhtmlx.DataStore.prototype.assert_event=function(master){
		dhtmlx.assert_event(master,{
			onbeforeAdd:{
				descr:"before adding item to datastore",
				obj:"data for new item",
				index:"index, at which new item will be added"
			},
			onafterAdd:{
				descr:"after adding item to datastore",
				obj:"data for new item",
				index:"index, at which new item was added"
			},
			onbeforeDelete:{
				descr:"before item deleting",
				id:"id of item in question"
			},			
			onafterDelete:{
				descr:"after item deleting",
				id:"id of item in question"
			},
			onbeforeSort:{
				descr:"before sorting dataset",
				by:"template of sort-by field",
				dir:"direction of sorting",
				as:"type of sorting"
			},
			onafterSort:{
				descr:"after sorting dataset",
				by:"template of sort-by field",
				dir:"direction of sorting",
				as:"type of sorting"
			}
		});
		dhtmlx.assert_method(master, {
			sort:{
				descr:	"sort data",
				min:	1,
				args:	[
					["sortBy", 	"sorting key", 				dhtmlx.assert_rule_any ],
					["direction", 	"sorting direction", 	dhtmlx.assert_rule_key({asc:true, desc:true}), true],
					["sortAs", 	"type of data sorting", 	dhtmlx.assert_rule_mix(
						dhtmlx.assert_rule_key({"string":true, "string_strict":true, "int":true}),dhtmlx.assert_rule_function), true ]
				]
			},
			add:{
				descr:	"add new item",
				min:	1,
				args: 	[
					["obj", 	"data object", 	dhtmlx.assert_rule_object ],
					["index", 	"position, at which item need to be added", 	dhtmlx.assert_rule_dimension, true]
				]
			},
			remove:{
				descr:	"add new item",
			...
			exists:{
				descr:	"return {Boolean} true if item with such ID exists",
				args: 	[
					["id", 	"id of item in question", 	dhtmlx.assert_rule_any]
				]
			},
			idByIndex:{
				descr:	"return {String} ID of item at provided ID",
				args: 	[
					["index", 	"index of item in question", 	dhtmlx.assert_rule_dimension]
				]
			},
			indexById:{
				descr:	"return {Number} index of item in question",
				args: 	[
					["id", 	"id of item in question", 	dhtmlx.assert_rule_any]
				]
			},
			get:{
				descr:	"return {Object} hash with properties of item",
				args: 	[
					["id", 	"id of item in question", 	dhtmlx.assert_rule_any]
				]
			},
			set:{
				descr:	"set new hash of properties for the item",
				args: 	[
					["id",		"id of item in question", 	dhtmlx.assert_rule_any],
					["data",	"hash of data", 	dhtmlx.assert_rule_object]
				]
			},
			refresh:{
				descr:	"repaint view",
				min:"0",
				args: 	[
					["id", 	"repaint only item with provided ID", 	dhtmlx.assert_rule_any, true]
				]
			},
			next:{
				descr:	"return {String} ID of item, which is next to current",
				args: 	[
					["id", 	"id of item in question", 	dhtmlx.assert_rule_any]
				]
			},
			previous:{
				descr:	"return {String} ID of item, which is previous to current",
				args: 	[
					["id", 	"id of item in question", 	dhtmlx.assert_rule_any]
				]
			},
			first:{
				descr:	"return {String} ID of first item",
				args: 	[]
			},
			last:{
				descr:	"return {String} ID of last item",
				args: 	[]
			},
			dataCount:{
				descr:	"return {Number} count of items",
				args: 	[]
			},
			clearAll:{
				descr:	"remove all items from the component",
				args: 	[]
			},
			filter:{
				descr:	"sort data",
				min:	1,
				args:	[
					["filter", 	"filter by  key", 	dhtmlx.assert_rule_mix(dhtmlx.assert_rule_template, dhtmlx.assert_rule_object) ],
					["value", 	"filter by value", 	dhtmlx.assert_rule_any, true]
				]
			}
		});					
	};
...
if (dhtmlx.assert_enabled()){
	dhtmlx.DataLoader._assert=function(){
		dhtmlx.assert_event(this,{
			onxls:{
				descr:"before xml loading start"
		},
			onxle:{
				descr:"after xml loading end"
		}
		});
			
		dhtmlx.assert_method(this, {
			load:{
				descr:	"load data from external file",
				min:	1,
				args:	[
					["url", 		"url to load", 				dhtmlx.assert_rule_string],
					["callback", 	"function which will be executed after data loading", 	
						dhtmlx.assert_rule_mix(dhtmlx.assert_rule_function,dhtmlx.assert_rule_string), true],
					["type", 		"name of loading type", 	dhtmlx.assert_rule_string, true]
				]
			},
			parse:{
				descr:	"load data from on-page resource",
				min:	1,
				args: 	[
					["data", 	"reference to data object", 	dhtmlx.assert_rule_any],
					["type", 	"name of loading type", 		dhtmlx.assert_rule_string, true]
				]				
			}
		});
...
if (dhtmlx.assert_enabled()){
	dhtmlXDataView.prototype._assert=function(){
		dhtmlx.assert_property(this,{
			auto_scroll:[ "Auto scroll view dureing drag-n-drop" , dhtmlx.assert_rule_boolean ]
		});
	};
}